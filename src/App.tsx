...
import BreedingGroups from "./pages/farmer/BreedingGroups";
import EggBatchManagement from "./pages/farmer/EggBatchManagement";
import HatcheryProduction from "./pages/farmer/HatcheryProduction"; 
    ...
    return (
      <FarmerLayout>
        <Routes>
          ...
          <Route path="/farmer/egg-batches" element={<EggBatchManagement />} />
          {/* ADD THIS NEW ROUTE */}
          <Route path="/farmer/hatchery-production" element={<HatcheryProduction />} />
          <Route path="/farmer/harvest-management" element={<HarvestManagement />} />
          <Route path="*" element={<Navigate to="/farmer" replace />} />
        </Routes>
      </FarmerLayout>
    );
