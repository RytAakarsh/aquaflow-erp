...
const TransportRequests = () => {
  ...
  const [requests, setRequests] = useState<TransportRequest[]>([
    { id: "TR-001", source: pt ? "Fazenda Silva - São Paulo" : "Silva Farm - São Paulo", destination: pt ? "Processamento Central" : "Central Processing", itemType: pt ? "Peixes" : "Fish", quantity: "1.200 kg", priority: pt ? "Normal" : "Normal", status: pt ? "Entregue" : "Delivered", createdAt: "2026-04-07", requestedBy: "Carlos Silva" },
    { id: "TR-002", source: pt ? "Incubatório - Minas Gerais" : "Hatchery - Minas Gerais", destination: pt ? "Fazenda Santos" : "Santos Farm", itemType: pt ? "Alevinos" : "Fry", quantity: "5.000 un", priority: pt ? "Urgente" : "Urgent", status: pt ? "Em Trânsito" : "In Transit", createdAt: "2026-04-08", requestedBy: "Admin" },
    ...
    { id: "TR-004", source: pt ? "Reprodução - Bahia" : "Breeding - Bahia", destination: pt ? "Incubatório - MG" : "Hatchery - MG", itemType: pt ? "Ovos" : "Eggs", quantity: "50.000 un", priority: pt ? "Urgente" : "Urgent", status: pt ? "Entregue" : "Delivered", createdAt: "2026-04-06", requestedBy: "Rafael Costa" },
